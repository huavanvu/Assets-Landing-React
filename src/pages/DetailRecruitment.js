                  ...
                  {this._renderJobDetail(jobs, this.props.match.params.id)}
                    ...
                    <div className="recruitment-detail__footer">
                      <div className="d-flex justify-content-between">
                        <button onClick={this._goBack} type="button" className="btn btn-lg btn-info apply-button">Back</button>
                        <button type="button" className="btn btn-lg bg-danger"><a className="apply-button" href="https://docs.google.com/forms/d/e/1FAIpQLSdowcuqcF4-TCewPrBCxHMiWroLm0lQfdoMqhdqVSU6jPygmQ/viewform"  target="_blank">Aplly Here</a></button>
                      </div>
                    </div>
                  </div>
                </div>
